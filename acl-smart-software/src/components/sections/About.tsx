...
const COPY = {
  ro: {
    ...
    p2: 'Lucrăm cu corporații, startup-uri și firme la mijloc. Proiectele cu constrângeri reale — termene scurte, sisteme legacy, integrări complicate, decizii grele — sunt cele unde contează experiența.',
    ...
    stats: [
      ...
      { big: '8', accent: '', lbl: 'Servicii oferite', desc: 'De la web și mobile la AI, Cloud și consultanță tehnică — acoperim întreg ciclul.' },
  ...
  en: {
    ...
    p2: 'We work with corporations, startups, and everything in between. Projects with real constraints — tight deadlines, legacy systems, tricky integrations, hard decisions — are where experience matters most.',
    ...
    stats: [
      ...
      { big: '8', accent: '', lbl: 'Services offered', desc: 'From web and mobile to AI, Cloud, and technical consulting — we cover the full lifecycle.' },
