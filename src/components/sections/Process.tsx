...
const COPY = {
  ro: { idx: '04 / PROCES', eyebrow: 'Cum lucrăm', h2: <>Acoperim tot fluxul <em>SDLC</em>.</>, steps: STEPS },
  en: { idx: '04 / PROCESS', eyebrow: 'How we work', h2: <>We cover the entire <em>SDLC</em>.</>, steps: STEPS_EN },
};
